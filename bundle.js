...
var _mouseDriver = require('./src/drivers/mouse-driver');

var _mouseDriver2 = _interopRequireDefault(_mouseDriver);

var _keysDriver = require('./src/drivers/keys-driver');

var _keysDriver2 = _interopRequireDefault(_keysDriver);

var _states = require('./src/states');
...
var STATES = [_states.EMPTY, _states.HEAD, _states.TAIL, _states.CONDUCTOR];

var CELL_WIDTH = 30;
var CELL_HEIGHT = 30;
var CELL_BACKGROUND = (_CELL_BACKGROUND = {}, _defineProperty(_CELL_BACKGROUND, _states.EMPTY, 'black'), _defineProperty(_CELL_BACKGROUND, _states.HEAD, 'red'), _defineProperty(_CELL_BACKGROUND, _states.TAIL, 'blue'), _defineProperty(_CELL_BACKGROUND, _states.CONDUCTOR, 'yellow'), _CELL_BACKGROUND);

function Grid(_ref) {
  var width = _ref.width;
  var height = _ref.height;

  return _lodash2.default.range(height).map(function () {
    return _lodash2.default.range(width).map(function () {
      return 0;
    });
  });
}
...
function renderGrid(grid) {
  return (0, _dom.div)('.grid', grid.map(renderRow));
}

function renderRow(row, rowIndex) {
  return (0, _dom.div)('.row', row.map(function (cell, cellIndex) {
    return renderCell(cell, rowIndex, cellIndex);
  }));
}

function renderCell(cell, row, column) {
  var y = row * CELL_WIDTH;
  var x = column * CELL_HEIGHT;
  var background = CELL_BACKGROUND[cell];
  ...
  return (0, _dom.div)('.cell', { key: row + column, style: style });
}

function renderDrawing(drawing) {
  return (0, _dom.div)('.drawing', { style: { position: 'absolute', 'z-index': 5 } }, {
    0: 'Empty',
    1: 'Head',
    2: 'Tail',
    3: 'Conductor'
...
function view(state) {
  return (0, _dom.div)('.wireworld', [renderDrawing(state.drawing), renderGrid(state.grid)]);
}

function debug(val) {
  return (0, _dom.div)(JSON.stringify(val));
}

function update(state) {
  return _extends({}, state, {

    grid: (0, _update2.default)(state.grid)
  });
}
...
var isMouseDown = (0, _streamTree2.default)(_templateObject, { xs: _xstream2.default });

var changeDrawing = (0, _streamTree2.default)(_templateObject2, { STATES: STATES, changeDrawingReducer$: changeDrawingReducer$, xs: _xstream2.default });

var drawCell = (0, _streamTree2.default)(_templateObject3, { toRowColumn: toRowColumn, drawCellReducer: drawCellReducer, xs: _xstream2.default, isMouseDown: isMouseDown });

var initialState = {
  grid: Grid({ width: 30, height: 20 }),
  drawing: _states.CONDUCTOR
};

var main = (0, _streamTree2.default)(_templateObject4, { initialState: initialState, view: view, xs: _xstream2.default, update: update, drawCell: drawCell, changeDrawing: changeDrawing });
...
var drivers = {
  ...
  Mouse: _mouseDriver2.default,
  Keys: _keysDriver2.default
};

(0, _xstreamRun.run)(main, drivers);

},{"./src/drivers/keys-driver":81,"./src/drivers/mouse-driver":82,"./src/states":83,"./src/update":84,"@cycle/dom":11,"@cycle/xstream-run":69,"lodash":75,"stream-tree":76,"xstream":80}],2:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":20,"xstream":80}],5:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"./ElementFinder":2,"./EventDelegator":3,"./fromEvent":8,"./isolate":12,"./utils":19,"@cycle/xstream-adapter":20,"matches-selector":21,"xstream":80}],6:[function(require,module,exports){
"use strict";
...
},{"xstream":80}],9:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./MainDOMSource":5,"./VNodeWrapper":7,"./isolateModule":13,"./modules":17,"./transposition":18,"./utils":19,"@cycle/xstream-adapter":20,"snabbdom":66,"xstream":80}],15:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"@cycle/xstream-adapter":20,"xstream":80}],17:[function(require,module,exports){
"use strict";
...
},{"@cycle/xstream-adapter":20,"xstream":80}],19:[function(require,module,exports){
"use strict";
...
},{"xstream":80}],21:[function(require,module,exports){
'use strict';
...
},{"@cycle/base":70,"@cycle/xstream-adapter":71}],70:[function(require,module,exports){
"use strict";
...
},{"dup":20,"xstream":80}],72:[function(require,module,exports){
...
},{"indexof":73}],73:[function(require,module,exports){
    ...
    var result = lines.reduce(function (state, line) {
      ...
      var newChannels = tokens.map(function (token, index) {
        ...
        if (token.type === 'code') {
          ...
          if (0 < overlappingChannels.length) {
...
},{"./range":77,"vm":72}],77:[function(require,module,exports){
"use strict";
...
function keysDriver() {
  return {
    down: function down(code) {
      ...
      return (0, _fromEvent2.default)(document, 'keydown').filter(function (event) {
...
},{"keycode":74,"xstream":80,"xstream/extra/fromEvent":79}],82:[function(require,module,exports){
'use strict';
...
function mousePositionDriver() {
  return {
    positions: function positions() {
      return (0, _fromEvent2.default)(document, 'mousemove').map(function (ev) {
        return { x: ev.clientX, y: ev.clientY };
      }).startWith({ x: window.innerWidth / 2, y: window.innerHeight / 2 });
    },


    click$: (0, _fromEvent2.default)(document, 'click'),
    down$: (0, _fromEvent2.default)(document, 'mousedown'),
    up$: (0, _fromEvent2.default)(document, 'mouseup')
  };
}

},{"xstream":80,"xstream/extra/fromEvent":79}],83:[function(require,module,exports){
"use strict";
...
var NEIGHBOUR_DIRECTIONS = [{ column: -1, row: -1 }, // NW
{ column: 0, row: -1 }, // N
{ column: 1, row: -1 }, // NE
{ column: 1, row: 0 }, // E
{ column: 1, row: 1 }, // SE
...
function inBounds(grid, position) {
  ...
  var rowInBounds = 0 <= position.row && position.row < gridHeight;
  var columnInBounds = 0 <= position.column && position.column < gridWidth;

  return rowInBounds && columnInBounds;
}

function mooreNeighbours(grid, row, column) {
  var possiblePositions = NEIGHBOUR_DIRECTIONS.map(function (direction) {
    return { row: row + direction.row, column: column + direction.column };
  }).filter(function (position) {
    return inBounds(grid, position);
  });

  return possiblePositions.map(function (position) {
...
function update(grid) {
  return grid.map(function (row, rowIndex) {
    return row.map(function (state, index) {
      if (state === _states.EMPTY) {
        return _states.EMPTY;
      }

      if (state === _states.HEAD) {
        return _states.TAIL;
      }

      if (state === _states.TAIL) {
        return _states.CONDUCTOR;
      }

      if (state === _states.CONDUCTOR) {
        var neighbours = mooreNeighbours(grid, rowIndex, index);

        var numbersOfNeighboursInHeadState = neighbours.filter(function (neighbourState) {
          return neighbourState === _states.HEAD;
        }).length;
